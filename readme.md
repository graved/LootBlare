...
- **Roll Cap Configuration**: You can configure the roll range caps (e.g. Transmog 50 instead of 98):
  `/lb cap <sr|ms|os|tm> <max>`
...
- **1.4.0**: Configurable roll caps via `/lb cap <sr|ms|os|tm> <max>` (e.g. Transmog 50 instead of 98)
